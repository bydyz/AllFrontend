...
console.log('绿色div的top', rectObject.top)
console.log('绿色div的right', rectObject.right)
console.log('绿色div的bottom', rectObject.bottom)
console.log('绿色div的left', rectObject.left)
console.log('绿色div的width', rectObject.width)
console.log('绿色div的height', rectObject.height)
...
getBoundingClientRect()用于获得页面中某个元素的左，上，右和下分别相对浏览器视窗的位置。  需要用id获取
  ...
  rectObject.top：元素上padding上边到视窗上边的距离;
	rectObject.right：元素右padding又边到视窗左边的距离;
...
console.log('绿色div的', secondDivById)
