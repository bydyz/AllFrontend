<template>
  ...
  <div>
    ...
    <vxe-grid ref="gridRef" v-bind="gridOptions1"></vxe-grid>
  </div>
</template>
...
const gridOptions = reactive({
  ...
  columns: [
    ...
    {
      title: "分类信息",
      children: [{ field: "date3", title: "Date" }],
    },
...
const gridOptions1 = reactive({
  ...
  columns: [
    ...
    },
    {
      field: "group1",
      title: "分类信息1",
      children: [{ field: "age", title: "Age", width: 120 }],
    },
    {
      field: "group2",
      title: "更多信息",
    ...
    },
    {
      field: "group3",
      title: "分类信息2",
      children: [{ field: "attr6", title: "Attr6", width: 300 }],
    },
    {
      field: "group4",
      title: "额外信息",
