...
export default {
  ...
  computed: {
    ...
    list () {
      console.log("rcrcrcrcrc RecycleScrollerDemo computed list", this.items)
  ...
  created() {
    console.log("rcrcrcrcrc RecycleScrollerDemo 中的 created", this.list)
  },
  ...
  methods: {
    generateItems () {
      ...
      const time = Date.now()
      console.log("rcrcrcrcrc 88888888888888888888888888888888888888888888888888888888888888", this.enableLetters)
      const items = getData(this.count, this.enableLetters)
      console.log('Generated ' + items.length + ' in ' + (Date.now() - time) + 'ms')
      this._dirty = true
      console.log("rcrcrcrcrc RecycleScrollerDemo 中的 generateItems", this.items, items)
      this.items = items
    },
