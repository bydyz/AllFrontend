...
export class App extends PureComponent {
  ...
  addBookCount(index) {
    ...
    const books = [...this.state.books]
    console.log('22222222222222222222222222222222222222222222222222222222', books, index)
    books[index].count++
    this.setState({ books: books })
  }
  ...
  render() {
    ...
    console.log('11111111111111111111111111111111111111111111111111111111', books)
