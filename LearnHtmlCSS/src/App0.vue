...
import LearnOlUl from "./components/LearnOlUl/index.vue";
...
let componentValue = ref("LearnOlUl");

const componentId = computed(() => {
  return componentsArray.value.find(a => a.value === componentValue.value).component
})
</script>
